      ...
      <section id="aksi-card">
        <div class="container mb-3">
          <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
              <div class="card">
                <img src="Deforestation threatens tree kangaroo habitat in Papua New Guinea 1.png" class="card-img-top" alt="..." />
                <div class="card-body">
                  ...
                  <a href="aksi-detail1.html" class="btn">
                    Read More
                  </a>
                </div>
              </div>
            ...
            <div class="col">
              <div class="card">
                <img src="aksi/Rectangle 6.png" class="card-img-top" alt="..." />
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="aksi/Rectangle 6 (1).png" class="card-img-top" alt="..." />
                <div class="card-body">
          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
              <div class="card">
                <img src="aksi/Rectangle 6 (2).png" class="card-img-top" alt="..." />
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="aksi/Rectangle 6 (3).png" class="card-img-top" alt="..." />
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="aksi/Rectangle 6 (4).png" class="card-img-top" alt="..." />
                <div class="card-body">
