            ...
            <section id='about-home'>
                <div className="container">
                    <div className="about-home">
                        ...
                        <p>Exploitation of environment rin the world make us being sad to see it. We try to make movement with a lot of conservation program that we initiate. Our program was made for better environment around us. We Try to reach a lot of environment to  change it become better place to live. Let’s join our program to give contribution to your environment.</p>
